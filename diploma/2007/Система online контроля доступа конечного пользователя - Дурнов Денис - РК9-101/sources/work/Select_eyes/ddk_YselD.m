...
for i = 1 : 5 : (N - n) % сдвиг на 5 пикселя при сканировнии по вертикали
    for j = 1 : 5 : (M - m) % аналогично выше написанному 
...
for i = 1 : p
    ...
    if (t1 > 0) & (t2 > 0)
     Temp(i, 3)
     Mask((t1 - 2):(t1 + 2), t2) = [1 1 1 1 1];
     Mask(t1, (t2 - 2):(t2 + 2)) = [1; 1; 1; 1; 1];
     %Mask(t1, t2) = 1;
    end
end
clear Temp;
