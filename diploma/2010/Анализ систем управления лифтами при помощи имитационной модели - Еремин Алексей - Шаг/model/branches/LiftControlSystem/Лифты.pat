...
_пассажир
	...
	Convert_rule
		СостояниеПас = Этаж_;
		Обслуживается = Функция_обслуживание(_этаж.Людей_находится);
_этаж
	Choice from
...
_пассажир
	Choice from 
		_пассажир.Место == 0 and _пассажир.СостояниеПас == Этаж_
	Convert_rule
		Обслуживается = 1;
_лифт
	Choice from
...
_пассажир
	Choice from
		_пассажир.Обслуживается == 0 and _пассажир.Текущий_этаж == _этаж.Номер
	Convert_rule
		Обслуживается = 1;
_лифт
	Choice from
...
$Pattern Образец_смена_часть_дня: rule trace
$Relevant_resources
	_система: система Keep
$Body
_система
	Choice from 
		_система.Часть_дня <> Смена_дня(Time_now)
	Convert_rule
		Часть_дня = Смена_дня(Time_now);
$End

$Pattern Образец_заданные_этажи: rule trace
$Relevant_resources
	_лифт     : Лифты   Keep
$Body
_лифт
	Choice from
		_лифт.Текущий_этаж   == _лифт.Требуемый_этаж and
		_лифт.Требуемый_этаж == _лифт.Конечный_этаж  and
		_лифт.НаправлениеЛ   == 0                    and
		_лифт.Людей_в_лифте  == 0                    and
		_лифт.Требуемый_этаж != Заданный_этаж(система.Часть_дня) and
		_лифт.Состояние != Едет
	Convert_rule
		Требуемый_этаж = Заданный_этаж(система.Часть_дня);
		Конечный_этаж  = Заданный_этаж(система.Часть_дня);
		Состояние      = Едет;
		НаправлениеЛ   = Направление_покоя(_лифт.Текущий_этаж, система.Часть_дня);
$End