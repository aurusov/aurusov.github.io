$Pattern Образец_нажатие_кнопки: rule trace
$Relevant_resources
...
$Pattern Образец_команды_пустому_лифту: rule trace
$Relevant_resources
	_этаж     : Этаж   NoChange
	_лифт     : Лифты  Keep
...
_лифт
	Choice from
		_лифт.Состояние == Стоит and _лифт.НаправлениеЛ == 0
	Convert_rule
		Конечный_этаж  = _этаж.Номер;
		Требуемый_этаж = _этаж.Номер;
		Состояние      = СостПустЛифт(_лифт.Требуемый_этаж, _лифт.Текущий_этаж);
		НаправлениеЛ   = НаправПустЛифт(_лифт.Состояние, _лифт.Требуемый_этаж, _лифт.Текущий_этаж, - _этаж.кнопка_вниз + _этаж.кнопка_вверх);
...
_пассажир
	Choice from 
		_пассажир.СостояниеПас   == Лифт
	and	_пассажир.Место          == _лифт.Номер
	and	_пассажир.Требуемый_этаж == _лифт.Текущий_этаж
	Convert_begin
...
$Pattern Образец_после_высадки: rule trace
$Relevant_resources
	_этаж:  Этаж   NoChange
	_лифт:  Лифты  Keep
		first
...
$Pattern Образец_посадки_пассажира: operation trace
$Relevant_resources
	_лифт    : Лифты      Keep  Keep
